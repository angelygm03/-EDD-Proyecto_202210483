...
void DoubleList::insertAtBeginning(string correo, string contenido, string fecha, string hora, string imagenPath) {
    NodeDoubleList* newNode = new NodeDoubleList(correo, contenido, fecha, hora, imagenPath);
...
void DoubleList::insertAtEnd(const string& correo, const string& contenido, const string& fecha, const string& hora, const string& imagenPath) {
    NodeDoubleList* newNode = new NodeDoubleList(correo, contenido, fecha, hora, imagenPath);
...
void DoubleList::insertAtPosition(int givenPosition, string correo, string contenido, string fecha, string hora, string imagenPath) {
    if (givenPosition <= 0) {
        insertAtBeginning(correo, contenido, fecha, hora, imagenPath);
    } else if (givenPosition >= size) {
        insertAtEnd(correo, contenido, fecha, hora, imagenPath);
    } else {
        NodeDoubleList* newNode = new NodeDoubleList(correo, contenido, fecha, hora, imagenPath);
